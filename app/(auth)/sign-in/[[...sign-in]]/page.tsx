...
export default function Page() {
  return (
    <div className='w-full min-h-screen flex justify-between items-center flex-col lg:flex-row'>
      <div className='w-full lg:w-[50%] flex flex-col items-center justify-center gap-7 min-h-screen auth-gradient'>
